...
function printContent() {
  $(document).on("click", ".message ", function () {
    ...
    var messCont = $(this).find(".messCont");
    var sendMess = $(this).find(".sendMess");
    messCont.slideToggle("hidden");
    sendMess.slideToggle("hidden");
  });
}

function init() {
  printContent(); // var mess = $(".message");
